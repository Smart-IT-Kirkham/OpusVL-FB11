...
$(function() {
  var favLink = $('.favourite-link');
    ...
    (function() {
        ...
        var $allDataTables = $('table.datatable');
        ...
        $('.js-tabs [role=tab]').on('select-tab', function(e, tab) {
            // We can no longer select simply the datatable we want, because
            // "fixedColums" utterly wrecks the DOM and the datatable simply
            // doesn't exist any more.
            $allDataTables.DataTable().draw();
        });
    })();
