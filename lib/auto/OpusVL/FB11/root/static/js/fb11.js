...
$(function () {
    ...
    //     }
    // })
    $('input[name="submit"]').addClass('btn btn-success')
    $('input[name="searchbutton"]').addClass('btn btn-success')
    $('.link_button_add').addClass('btn btn-info')
    $('input[name="submit"]').parent().addClass('dflex justify-content-end')
    $('.link_button_add').parent().addClass('dflex justify-content-end')
    $('input[name="searchbutton"]').parent().addClass('dflex justify-content-end')
    $('.token input').addClass('form-control')
    $('fieldset').children('div').addClass('form-group')
    $('fieldset div').children('input').addClass('form-control')
    $('fieldset div').children('select').addClass('form-control')
    $('select[name="_sort_key]').addClass('form-control')
    $('.elements select').addClass('form-control')
