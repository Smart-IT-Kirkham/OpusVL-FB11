...
CREATE TABLE `user_parameters` (
  ...
  INDEX `user_parameters_idx_id_prf_owner_type_id` (`id`, `prf_owner_type_id`),
  INDEX `user_parameters_idx_prf_owner_type_id` (`prf_owner_type_id`),
  PRIMARY KEY (`id`),
  CONSTRAINT `user_parameters_fk_id_prf_owner_type_id` FOREIGN KEY (`id`, `prf_owner_type_id`) REFERENCES `prf_owners` (`prf_owner_id`, `prf_owner_type_id`),
  CONSTRAINT `user_parameters_fk_prf_owner_type_id` FOREIGN KEY (`prf_owner_type_id`) REFERENCES `prf_owner_type` (`prf_owner_type_id`)
) ENGINE=InnoDB;
--
