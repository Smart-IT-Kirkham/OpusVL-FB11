...
-- Created on Mon Apr 30 11:31:47 2018
-- 
;
--
...
CREATE INDEX "user_parameters_idx_id_prf_owner_type_id" on "user_parameters" ("id", "prf_owner_type_id");
CREATE INDEX "user_parameters_idx_prf_owner_type_id" on "user_parameters" ("prf_owner_type_id");
...
;
ALTER TABLE "user_parameters" ADD CONSTRAINT "user_parameters_fk_id_prf_owner_type_id" FOREIGN KEY ("id", "prf_owner_type_id")
  REFERENCES "prf_owners" ("prf_owner_id", "prf_owner_type_id") DEFERRABLE;

;
ALTER TABLE "user_parameters" ADD CONSTRAINT "user_parameters_fk_prf_owner_type_id" FOREIGN KEY ("prf_owner_type_id")
