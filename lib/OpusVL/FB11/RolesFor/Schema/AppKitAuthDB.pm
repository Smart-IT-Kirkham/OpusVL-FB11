package OpusVL::FB11::RolesFor::Schema::AppKitAuthDB;

=head1 NAME

OpusVL::FB11::RolesFor::Schema::AppKitAuthDB
...
=head1 SYNOPSIS
    ...
    with 'OpusVL::FB11::RolesFor::Schema::AppKitAuthDB';
...
sub merge_authdb
{
    ...
    $class->load_namespaces(
        result_namespace => '+OpusVL::FB11::Schema::AppKitAuthDB::Result',
        resultset_namespace => '+OpusVL::FB11::Schema::AppKitAuthDB::ResultSet',
    );
}
