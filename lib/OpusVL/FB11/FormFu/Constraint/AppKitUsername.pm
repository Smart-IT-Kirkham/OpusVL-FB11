...
package OpusVL::FB11::FormFu::Constraint::AppKitUsername;

=head1 NAME

OpusVL::FB11::FormFu::Constraint::AppKitUsername - constraint to prevent duplicate usernames.
...
OpusVL::FB11::FormFu::Constraint::AppKitUsername - Username contraint for the AppKitAuthDB model.
...
=head1 SYNOPSIS
    ...
    - type: Text
      name: username
      constraints:
        - type: '+OpusVL::FB11::FormFu::Constraint::AppKitUsername'
          user_stashkey: user_for_update

=head1 DESCRIPTION

Ensures the value submitted is not already in use for a username with the AppKitAuthDB model.
